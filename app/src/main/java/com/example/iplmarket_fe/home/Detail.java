...
public class Detail extends AppCompatActivity {
    ...
    // 소켓 통신으로 obj파일 수신
    private Emitter.Listener RodeAr = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            ...
            try {
                ...
                if (success){ // 성공적인 전달
                    ...
                    saveModelingData(base64File, "modeling.obj");
                } else {
                    Log.e("AR modeling Response", "Err : " + data.getString("message"));
                }
    ...
    private void saveModelingData(String base64File, String fileName){
        try {
            ...
            Log.d("AR modeling", "Download Complete - Path: " + filePath);
        } catch (IOException e){
            e.printStackTrace();
        }
    }
